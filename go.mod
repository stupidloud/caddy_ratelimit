module github.com/example/caddy_rate_limit_module
...
// 允许与更新版本的 Caddy 兼容
replace github.com/caddyserver/caddy/v2 => github.com/caddyserver/caddy/v2 v2.8.0

// 解决 quic-go 与 Go 1.21 的兼容性问题
